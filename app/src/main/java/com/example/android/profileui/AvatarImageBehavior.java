...
public class AvatarImageBehavior extends CoordinatorLayout.Behavior<AppCompatImageView> {
    ...
    private void maybeInitProperties(AppCompatImageView child, View dependency) {
        ...
        if (mFinalXPosition == 0)
            mFinalXPosition = mContext.getResources().getDimensionPixelOffset(R.dimen.abc_action_bar_default_height_material) + ((int) mCustomFinalHeight / 2);
